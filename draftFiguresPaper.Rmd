...
### get dataset figure 2 papers
data_fig2_papers <- left_join(datasetClassificationCountries_long_clean, datasetPollution_ctr, by = "iso3")
write.csv(data_fig2_papers,"dataNew/data_fig2_papers.csv", row.names = FALSE)


### papers by country plus pollution
...
### get dataset figure 2 suveys
data_fig2_surveys <- left_join(surveyCountries_long_clean, datasetPollution_ctr, by = "iso3")
write.csv(data_fig2_surveys,"dataNew/data_fig2_surveys.csv", row.names = FALSE)
