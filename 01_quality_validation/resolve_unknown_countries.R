...
# datasetCountries <- read.csv("data/llm_classifications/countries_5mini.csv")
datasetCountries <- read.csv("data/llm_classifications/countries_o4mini.csv")
...
oldUnknownCountry <- read.csv("data/raw/unknown_countries_manual_EH.csv", sep = ";") 
...
fullDataset <- read.csv("data/raw/literature_dataset.csv")
...
datasetCountries5mini <- read.csv("data/llm_classifications/countries_5mini.csv")
...
manualCoded <- read.csv("data/raw/unknown_countries_manual_CF.csv", sep = ";")
