...
datasetGPT <- read.csv(paste("data/llm_classifications/inclusion_", modelName, ".csv", sep = ""))
...
ggsave(plot = p1, filename = paste("01_quality_validation/plots/inclusionGPTHuman", modelName, ".png", sep = ""),
...
ggsave(plot = p2, filename = paste("01_quality_validation/plots/inclusionGPTHumanBar", modelName, ".png", sep = ""),
       dpi=600, width = 16, height = 12, units='cm')
...
ggsave(plot = p3, filename = paste("01_quality_validation/plots/inclusionGPTHumanPositiveRate", modelName, ".png", sep = ""),
       dpi=600, width = 16, height = 12, units='cm')
