...
## Clean the data (would skip this?)
...
## now is already in the papers dataset, could change values based on pollution value (pm25$categoryPollution <- cut(papers$pm25Avg, breaks = c(0, 10, 15, 25, 35, 100), 
