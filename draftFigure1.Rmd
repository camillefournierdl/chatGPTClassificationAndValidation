...
ggsave(plot = p1, filename = paste("plots/Figure1_papers_by_income.png", sep = ""),
...
ggsave(plot = p3, filename = paste("plots/Figure1_papers_by_exposure.png", sep = ""),
...
ggsave(plot = p4, filename = paste("plots/Figure1_surveys_by_exposure.png", sep = ""),
       dpi=600, width = 10, height = 8, units='cm')
...
pdf("plots/Figure1_surveys_by_income_eurob.pdf", width = 10)
p2
dev.off()

# p2 <- p2 + theme(axis.text.x=element_text(angle = 30, hjust = 1, vjust = 1))

ggsave(plot = p2, filename = paste("plots/Figure1_surveys_by_income_eurob.png", sep = ""),
       dpi=600, width = 11, height = 8, units='cm')
...
pdf("plots/Figure1_surveys_by_exposure_eurob.pdf", width = 10)
p4
dev.off()

ggsave(plot = p4, filename = paste("plots/Figure1_surveys_by_exposure_eurob.png", sep = ""),
       dpi=600, width = 10, height = 8, units='cm')
