...
# save the plot
ggsave(plot = map_plot_reference, filename = paste("robustness/plots/mapExposureGroups.png", sep = ""),
       dpi=600, width = 16, height = 12, units='cm')
...
# save the plot
ggsave(plot = map_plot_reference, filename = paste("robustness/plots/mapIncomeGroup.png", sep = ""),
       dpi=600, width = 16, height = 12, units='cm')
```
